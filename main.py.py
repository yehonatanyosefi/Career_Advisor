...
# Blood Test Results
hemoglobin = demographic['blood_test_results']['hemoglobin']
platelet_count = demographic['blood_test_results']['platelet_count']

# Blood Vitamin Levels
vitamin_d = demographic['blood_vitamin_levels']['vitamin_d']
vitamin_b12 = demographic['blood_vitamin_levels']['vitamin_b12']

# Socioeconomic Information
household_income = demographic['socioeconomic_information']['household_income']
education = demographic['socioeconomic_information']['education']
...
# Self Description
description_1 = self_description['description_1']
description_2 = self_description['description_2']
